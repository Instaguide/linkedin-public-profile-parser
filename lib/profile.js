...
module.exports = function profile(url, html, next) {
  ...
  if (certifications.length > 0) {
    for (i = 1; i <= schools.length; i++) {
      ...
      certification.authority = $('#certifications .school:nth-child(' + i + ') h5.item-subtitle a').text();
      var authority = $('#certifications .school:nth-child(' + i + ') h5.item-subtitle').text();
      certification.licenseNumber = authority.substr(certification.authority.length);
      certification.date = $('#certifications .school:nth-child(' + i + ') .date-range').text();
